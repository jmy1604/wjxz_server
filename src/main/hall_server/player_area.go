	...
	*/
	...
	for _, tmp_building = range area_cfg.DefMapBuildings {
		...
		*/
		...
		new_building_id = this.SetMapBuilding(tmp_building.Id, tmp_building.Point[0], tmp_building.Point[1], tmp_building.Rotation, 0, true) //this.TrySetMapBuildingDefDir(tmp_building.Id)
