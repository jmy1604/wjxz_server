...
func (this *Player) GetCatState(cat_id int32) int32 {
	...
	} else if this.db.FosterCatOnFriends.HasIndex(cat_id) {
...
func (this *Player) feed_cat(cat_id int32, food int32, add_exp int32, is_critical bool) (int32, int32, int32) {
	...
	// 公告
	if is_max_level {
		anouncement_mgr.PushNew(ANOUNCEMENT_TYPE_CAT_FULL_LEVEL, true, this.Id, cat.Id, curr_level, 0, "")
	}
...
func (this *Player) update_ouqi(cat_id int32) {
	...
	if this.rpc_rank_update_cat_ouqi(cat_id, ouqi) == nil {
...
func (this *Player) get_player_cat_info(player_id int32, cat_id int32) int32 {
	...
	if player == nil {
		result := this.rpc_player_cat_info(player_id, cat_id)
		if result.Error < 0 {
			return result.Error
		}
