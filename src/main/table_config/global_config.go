...
type GlobalConfig struct {
	...
	ArenaWinAddScore              int32      // 竞技场胜增加积分
	ArenaRepeatedWinAddExtraScore int32      // 竞技场连胜增加额外积分
	ArenaLoseAddScoreOnLowGrade   int32      // 竞技场失败低段位增加积分
	ArenaLoseAddScoreOnHighGrade  int32      // 竞技场失败高段位增加积分
