...
func (this *CatHouseTableMgr) Init() bool {
	if !this.Load() {
		log.Error("CatHouseTableMgr Init load failed !")
		return false
	}
	return true
}

func (this *CatHouseTableMgr) Load() bool {
	data, err := ioutil.ReadFile("../game_data/Cathouse.xml")
	if nil != err {
