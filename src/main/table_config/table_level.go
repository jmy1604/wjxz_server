...
func (this *LevelTableMgr) Init() bool {
	if !this.Load() {
		log.Error("LevelTableMgr Init load failed !")
		return false
	}
	return true
}

func (this *LevelTableMgr) Load() bool {
	data, err := ioutil.ReadFile("../game_data/level.xml")
	if nil != err {
