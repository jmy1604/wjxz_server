...
func (this *FosterTableMgr) Init() bool {
	if !this.Load() {
		log.Error("FosterTableMgr Init load failed !")
		return false
	}
	return true
}

func (this *FosterTableMgr) Load() bool {
	data, err := ioutil.ReadFile("../game_data/foster.xml")
	if nil != err {
