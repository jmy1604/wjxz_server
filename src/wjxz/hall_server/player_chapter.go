...
func (this *Player) ChkSendNewUnlockStage() {
	if this.new_unlock_chapter_id > 0 {
		...
		res2cli.ChapterId = proto.Int32(this.new_unlock_chapter_id)
		res2cli.MaxUnlockStageId = proto.Int32(this.db.Info.GetMaxUnlockStage())
...
func (this *Player) ChkDayHelpUnlockNum(bsend bool) {
	...
	if bsend {
		...
		res2cli.HelpOtherNum = proto.Int32(global_config_mgr.GetGlobalConfig().MaxHelpUnlockNum - this.db.Info.GetDayHelpUnlockCount())
...
func (this *Player) HelpUnlock(pid, chapter_id int32) int32 {
	...
	if this.db.Info.GetDayHelpUnlockCount() >= global_config_mgr.GetGlobalConfig().MaxHelpUnlockNum {
...
func reg_player_chapter_msg() {
	msg_handler_mgr.SetPlayerMsgHandler(msg_client_message.ID_C2SChapterUnlock, C2SChapterUnlockHandler)
	msg_handler_mgr.SetPlayerMsgHandler(msg_client_message.ID_C2SGetCurHelpReqPIds, C2SGetCurHelpReqPIdsHandler)
...
func C2SChapterUnlockHandler(w http.ResponseWriter, r *http.Request, p *Player, msg proto.Message) int32 {
	req := msg.(*msg_client_message.C2SChapterUnlock)
	...
	cur_max_chapter_cfg := cfg_chapter_mgr.Map[cur_max_chapter_id]
	...
	cur_chapter_cfg := cfg_chapter_mgr.Map[chapter_id-1]
	...
	case PLAYER_CHAPTER_UNLOCK_TYPE_DIAMOND:
		{
			...
			need_diamond := (needsec + global_config_mgr.GetGlobalConfig().ChapterUnlockSecPerDiamond - 1) / global_config_mgr.GetGlobalConfig().ChapterUnlockSecPerDiamond
	...
	res2cli := &msg_client_message.S2CChapterUnlock{}
	res2cli.ChapterId = proto.Int32(chapter_id)
	res2cli.MaxUnlockStageId = proto.Int32(chapter_cfg.MaxStageId)
...
func C2SGetCurHelpReqPIdsHandler(w http.ResponseWriter, r *http.Request, p *Player, msg proto.Message) int32 {
