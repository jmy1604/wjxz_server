...
// 获取好友寄养所
type H2H_FosterGetFriendCats struct {
	FromPlayerId int32
	ToPlayerId   int32
}
type H2H_FosterGetFriendCatsResult struct {
	Cats            []*H2H_FosteredCat
	CanFosteredSlot int32
	OutFriendCats   map[int32][]int32
}

// 获取寄养收益
type H2H_FosterIncome struct {
	FromPlayerId int32
	ToPlayerId   int32
}
type H2H_FosterIncomeResult struct {
	FromPlayerId int32
	ToPlayerId   int32
	CatIds       []int32
	CardIds      []int32
...
// 清除寄养结束的猫
type H2H_FosterClearFinishedCats struct {
	FromPlayerId int32
	ToPlayerId   int32
	OutCats      []int32
}
type H2H_FosterClearFinishedCatsResult struct {
}

// 结束寄养
type H2H_FosterFinishCats struct {
	FromPlayerId int32
	ToPlayerId   int32
	Cats         []int32
}
type H2H_FosterFinishCatsResult struct {
}
